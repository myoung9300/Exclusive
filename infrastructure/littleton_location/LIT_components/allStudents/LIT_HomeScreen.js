...
const LIT_HomeScreen = ({ navigation }) => {
	...
	return (
		<SafeAreaView style={{ flex: 1, backgroundColor: COLORS.littletonBlue }}>
			...
			<ScrollView showsVerticalScrollIndicator={false}>
				<TouchableOpacity
					onPress={() => navigation.navigate("Littleton Notifications")}
				>
				...
				<TouchableOpacity onPress={() => navigation.navigate("LIT Basic")}>
					<Text style={styles.area}>Lil' Dragons & Basic</Text>
				</TouchableOpacity>
				<TouchableOpacity onPress={() => navigation.navigate("LIT Level 1")}>
					<Text style={styles.area}>Level 1</Text>
				</TouchableOpacity>
				<TouchableOpacity onPress={() => navigation.navigate("LIT Level 2")}>
					<Text style={styles.area}>Level 2</Text>
				</TouchableOpacity>
				<TouchableOpacity onPress={() => navigation.navigate("LIT Level 3")}>
					<Text style={styles.area}>Level 3</Text>
				</TouchableOpacity>
				<TouchableOpacity onPress={() => navigation.navigate("LIT Black Belt")}>
					<Text style={styles.area}>Black Belt</Text>
				</TouchableOpacity>
				<TouchableOpacity onPress={() => navigation.navigate("LIT Exclusive")}>
