...
import LIT_Portal from "../LIT_main_NAV/studentPortal/LIT_Portal";

const Tab = createBottomTabNavigator();

const TabArr = [
	{
		route: "Littleton Navigator",
		label: "Home",
		type: Icons.Ionicons,
		activeIcon: "grid",
...
export default LittletonNavigation;
