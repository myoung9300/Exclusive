...
const LKW_Lvl1_Nav = ({ navigation }) => {
	return (
		<View style={{ flex: 1, backgroundColor: COLORS.lakewoodBlue }}>
			<ScrollView>
				<TouchableOpacity
					onPress={() => navigation.navigate("LKW Level 1 Curriculum")}
				>
				...
				<TouchableOpacity
					onPress={() => navigation.navigate("LKW Level 1 Testing")}
				>
