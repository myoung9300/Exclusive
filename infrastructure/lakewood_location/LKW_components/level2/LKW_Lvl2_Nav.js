...
const LKW_Lvl2_Nav = ({ navigation }) => {
	return (
		<View style={{ flex: 1, backgroundColor: COLORS.lakewoodBlue }}>
			<ScrollView>
				<TouchableOpacity
					onPress={() => navigation.navigate("LKW Level 2 Curriculum")}
				>
				...
				<TouchableOpacity
					onPress={() => navigation.navigate("LKW Level 2 Testing")}
				>
